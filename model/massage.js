...
const massageSchema = new mongoose_1.Schema({
    to: {
...
massageSchema.plugin(mongoose_lean_defaults_1.default);
exports.default = mongoose_1.default.model('Massage', massageSchema);
